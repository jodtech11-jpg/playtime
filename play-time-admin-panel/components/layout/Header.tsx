              ...
              {searchLoading ? (
                ...
                <>
                  <div className="p-3 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50">
                    <p className="text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-widest">
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {result.subtitle && (
                                <p className="text-xs text-gray-600 dark:text-slate-400 mb-1">{result.subtitle}</p>
                              )}
                              {result.description && (
                                <p className="text-xs text-gray-500 dark:text-slate-400 line-clamp-1">{result.description}</p>
                              )}
                            </div>
                            <span className="material-symbols-outlined text-gray-400 dark:text-slate-500">arrow_forward</span>
                          </div>
                        </button>
                      );
                    })}
              ...
              <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors flex items-center gap-3"
                  >
                    <span className="material-symbols-outlined text-gray-600 dark:text-slate-400">calendar_view_week</span>
                    <div>
                      <p className="text-sm font-bold text-gray-900 dark:text-gray-100">Week View</p>
                      <p className="text-xs text-gray-500 dark:text-slate-400">7-day schedule</p>
                    </div>
                  </button>
                  <button
                    onClick={() => {
                    ...
                    className="w-full text-left px-4 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors flex items-center gap-3"
                  >
                    <span className="material-symbols-outlined text-gray-600 dark:text-slate-400">calendar_view_month</span>
                    <div>
                      <p className="text-sm font-bold text-gray-900 dark:text-gray-100">Month View</p>
                      <p className="text-xs text-gray-500 dark:text-slate-400">Full month calendar</p>
                    </div>
                  </button>
                </div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Today: {new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
              </div>
            </div>
          )}
        </div>
