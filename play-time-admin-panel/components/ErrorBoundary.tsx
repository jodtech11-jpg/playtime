          ...
          <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mb-6 p-4 bg-red-50 rounded-xl border border-red-100">
                ...
                {this.state.errorInfo && (
                  <details className="mt-3">
                    ...
                    <pre className="mt-2 text-xs text-red-600 overflow-auto max-h-48 p-2 bg-red-50 rounded border border-red-100">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-6 py-3 bg-gray-100 text-gray-900 rounded-xl font-black uppercase tracking-widest text-xs hover:bg-gray-200 transition-all"
              >
                Reload Page
              </button>
            </div>
