    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-black text-gray-700 mb-2">Role *</label>
              <input
                type="text"
                value={formData.role}
            ...
            <div>
              <label className="block text-sm font-black text-gray-700 mb-2">Department</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-black text-gray-700 mb-2">Monthly Salary (₹) *</label>
              <input
                type="number"
                min="0"
                step="0.01"
