  ...
  return (
    <>
      ...
      <div className="relative flex h-full">
        <aside className={`fixed lg:static inset-y-0 left-0 w-64 ui-sidebar flex flex-col h-full shrink-0 z-40 lg:z-20 transform transition-transform duration-300 ease-in-out ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
          <div className="h-16 flex items-center px-6 border-b border-white/5">
            <div className="flex items-center gap-3">
              <div className="size-8 rounded-lg bg-primary flex items-center justify-center text-primary-content">
                <span className="material-symbols-outlined text-2xl font-bold">sports_tennis</span>
              </div>
              <div>
                <h1 className="text-base font-bold leading-none tracking-tight">Play Time</h1>
            ...
            <div className="mt-1 relative">
              <button
                onClick={() => {
                  ...
                  // Close venues menu when opening users menu
                  if (newState) {
                    setVenuesMenuOpen(false);
                  }
                }}
              ...
              >
                ...
                <span className={`material-symbols-outlined text-lg transition-transform duration-200 ${usersMenuOpen ? 'rotate-90' : ''}`}>
                  chevron_right
                </span>
              </button>
            </div>
              ...
              <div className="mt-1 relative">
                <button
                  onClick={() => {
                    ...
                    // Close users menu when opening venues menu
                    if (newState) {
                      setUsersMenuOpen(false);
                    }
                  }}
                ...
                >
                  ...
                  <span className={`material-symbols-outlined text-lg transition-transform duration-200 ${venuesMenuOpen ? 'rotate-90' : ''}`}>
                    chevron_right
                  </span>
                </button>
              </div>
          ...
          <div className="p-4 border-t border-white/5">
            <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/5 border border-white/5 group hover:border-white/20 transition-colors">
              <NavLink
                to="/profile"
              ...
              <button onClick={() => { signOut(); setMobileMenuOpen(false); }} className="text-gray-400 dark:text-gray-500 hover:text-red-400 transition-colors" title="Sign Out">
        ...
        {venuesMenuOpen && (isSuperAdmin || isVenueManager) && (
