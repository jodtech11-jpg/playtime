...
class SocialService {
  ...
  static Future<void> toggleLike(String postId, String userId) async {
    try {
      ...
      if (e.toString().contains('permission-denied')) {
        debugPrint(
          'Firestore Permission Denied: You may not have permission to update the "posts" collection or the "likes" subcollection.',
        );
        debugPrint(
          'Check your Firestore Security Rules for "posts" and "posts/{postId}/likes".',
        );
      }
  ...
  static Stream<List<Map<String, dynamic>>> getPostCommentsStream(
    String postId,
  ) {
    return _firestore
        .collection('posts')
