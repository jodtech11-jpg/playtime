  ...
  Future<void> _verifyOtp(String otp) async {
    ...
    try {
      ...
      final verificationId =
          authProvider.verificationId ?? widget.verificationId;
      ...
      final success = await authProvider.verifyOtp(verificationId, otp);
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            // Explicit padding so the digit is never clipped
