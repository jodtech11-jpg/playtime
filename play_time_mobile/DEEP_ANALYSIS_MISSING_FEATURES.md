...
> **⚠️ HISTORICAL DOCUMENT — most items listed are now implemented.**
> Razorpay payments, slot locks / transactional booking, social likes /
> comments, marketplace checkout, and FCM / notifications are all in
> `lib/`. Keep this file for history only.

**Date**: 2024-12-19
**Status**: Comprehensive Analysis Complete (obsolete — see note above)
